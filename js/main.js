  ...
  xhr.onreadystatechange = function() { 
    ...
    if (xhr.readyState == 4){
      if (xhr.status == 200) {
        ...
        document.getElementById("result3").innerHTML = '<p> <snap style="font-weight:bold;font-size:smaller;color:lightgray">' + (Number(response.predictions[2].probability).toFixed(2)) + '</snap><br><snap style="font-weight:normal;font-size:smaller;color:lightgray">' + response.predictions[2].tagName.toUpperCase() + '</snap></p>';
        document.getElementById("result4").innerHTML = '<p> <snap style="font-weight:bold;font-size:smaller;color:lightgray">' + (Number(response.predictions[3].probability).toFixed(2)) + '</snap><br><snap style="font-weight:normal;font-size:smaller;color:lightgray">' + response.predictions[3].tagName.toUpperCase() + '</snap></p>';
        document.getElementById("result5").innerHTML = '<p> <snap style="font-weight:bold;font-size:smaller;color:lightgray">' + (Number(response.predictions[4].probability).toFixed(2)) + '</snap><br><snap style="font-weight:normal;font-size:smaller;color:lightgray">' + response.predictions[4].tagName.toUpperCase() + '</snap></p>';
      } else {
